...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """Return the JSON string serialization of a list of dicts.
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON string serialization of a list of objects into a file.
        ...
        with open(filename, "w") as jsonfile:
            if list_objs is None:
                ...
                list_dicts = [l.to_dictionary() for l in list_objs]
    ...
    def create(cls, **dictionary):
        ...
        Args:
            **dictionary (dict): Key/val pairs of attributes to initial the cls.
        """
